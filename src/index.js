...
module.exports = async function App(context) {
  ...
  displayName = user_table[context.event.source.userId]
...
地圖連結:https://g.page/huweiduckcom?share`);
      await context.pushConfirmTemplate('感覺到你很喜歡美食，有興趣參與我們的人格測驗，匹配出專屬你的專屬行程嗎?', {
      ...
      break;
    case 5:
      await context.pushConfirmTemplate('在旅行中，你是個注重儀式感的人嗎?', {
      ...
      break;
    case 6:
      await context.pushConfirmTemplate('如果今天有一條百年老店美食街，你會選擇', {
      ...
      break;
    case 7:
      await context.pushConfirmTemplate('進入店家後點餐，發現你想吃的餐點賣完了，你會', {
      ...
      break;
    case 8:
      await context.pushConfirmTemplate('在下一間店享用完餐點後，當店員推銷伴手禮，你會', {
...
你是一個自由行狂熱者，面對選擇你通常以當下的感受做決定，享受旅行帶給你的未知與探險

根據五大人格特質測驗的量表，我們推估你在OEA三大面向指數較高

並結合你的問答與旅行需求，我們為你設計了以美食為主的吃貨大胃王一條街行程
...
以上資料，根據對話的問題與訊息的語意分析資料產出，僅供參考，謝謝妳的使用`)
